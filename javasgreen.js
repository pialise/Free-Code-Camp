...
document.getElementById("clickforanswer").innerHTML = "Click for greenlandish";
document.getElementById("greenlandish").innerHTML = displayGreenName;
document.getElementById("greenlandish").style.color= "#337ab7";
  //console.log([displayEngName, displayGreenName]);
}
  function answerFunction(){
   document.getElementById("greenlandish").style.color= "white"; 
       }
